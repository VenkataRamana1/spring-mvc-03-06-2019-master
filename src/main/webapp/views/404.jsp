...
.shadow {
	...
	width: 150px;
	height: 100%;
	background-image: linear-gradient(to right, rgba(1, 20, 61, 0),
		rgba(1, 20, 61, 0.8) 65%, rgba(1, 20, 61, 1));
}
...
.glow__bottom {
	...
	width: 135px;
	height: 120px;
	background-image: linear-gradient(to top, rgba(132, 255, 242, 1),
		rgba(132, 255, 242, 1) 30%, rgba(132, 255, 242, 0));
...
.glow__top {
	...
	height: 180px;
	background-image: linear-gradient(to top, rgba(132, 255, 242, 1),
		rgba(132, 255, 242, 1) 20%, rgba(132, 255, 242, 0));
...
<body>
	...
	<img alt="404" src="/spring-mvc-zero-xml/resources/img/error/404.png" style="
    width: 850px;
">
	</div>
</body>
