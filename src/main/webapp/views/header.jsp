...
<link rel="stylesheet" href="/spring-mvc-zero-xml/resources/css/AdminLTE.min.css">
<!-- AdminLTE Skins. Choose a skin from the css/skins
       folder instead of downloading all of them to reduce the load. -->
<link rel="stylesheet" href="/spring-mvc-zero-xml/resources/css/skins/_all-skins.min.css">
<!-- Morris chart -->
<link rel="stylesheet"
...
<!-- jQuery 3 -->
<script src="/spring-mvc-zero-xml/resources/bower_components/jquery/dist/jquery.min.js"></script>
<!-- jQuery UI 1.11.4 -->
<script src="/spring-mvc-zero-xml/resources/bower_components/jquery-ui/jquery-ui.min.js"></script>
...
<!-- Morris.js charts -->
<script src="/spring-mvc-zero-xml/resources/bower_components/raphael/raphael.min.js"></script>
<script src="/spring-mvc-zero-xml/resources/bower_components/morris.js/morris.min.js"></script>
<!-- Sparkline -->
<script
...
<!-- daterangepicker -->
<script src="/spring-mvc-zero-xml/resources/bower_components/moment/min/moment.min.js"></script>
<script
...
<!-- FastClick -->
<script src="/spring-mvc-zero-xml/resources/bower_components/fastclick/lib/fastclick.js"></script>
<!-- AdminLTE App -->
...
<script type="text/javascript" src="/spring-mvc-zero-xml/resources/js/adminlte.js"></script>
<!-- Google Font -->
<link rel="stylesheet"
...
<div>
  <header class="main-header">
    ...
    <a href="../index2.html" class="logo">
      ...
      <span class="logo-mini"><b>G</b>EN</span>
    ...
    <section class="sidebar" style="height: auto;">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="/spring-mvc-zero-xml/resources/img/user2-160x160.jpg" class="img-circle" alt="User Image">
        </div>
      ...
      <ul class="sidebar-menu tree" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/spring-mvc-zero-xml"><i class="fa fa-circle-o"></i> Dashboard</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/spring-mvc-zero-xml/category"><i class="fa fa-circle-o"></i> Category </a></li>
            <li><a href="/spring-mvc-zero-xml/addCategory"><i class="fa fa-circle-o"></i>  Add Category</a></li>
